...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/galleryStyle.css">
<script type="text/javascript">
	function opendialog() {
		var $dialog = $('#dialog1')
				.html(
						'<iframe style=" border-style: solid;border-color: #000000" src="'
								+ this.children[0].src
								+ '" width="100%" height="100%"></iframe>')
				.dialog(
						{
							title : this.children[0].alt !== undefined ? this.children[0].alt
									: 'Image',
							autoOpen : false,
...
<div class="gallery-container">
	<form:form id="mainForm">
		...
		<div id="dialog1" title="Dialog Title" hidden="hidden">I'm a
			dialog</div>
